    ...
    <div className="bg-[#1A2031] h-[92px]">
      <div className="container mx-auto">
        <div className="flex justify-between items-center h-[92px]">
          <Link
            to={getLinkWithLang("/")}
            className="logo flex items-center h-full"
          >
            <img
          ...
          <ul
            className={`flex font-Poppins items-center h-full max-md:absolute max-md:z-20 max-md:flex-col max-md:bg-[#1A2031] max-md:h-max max-md:w-[350px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:rounded ease-linear ${
              active ? "max-md:top-[-400px]" : "max-md:top-[120px]"
            }`}
          >
            <Link
              to={getLinkWithLang("/about")}
              className={`text-white md:ml-8 max-md:pt-8 max-md:pb-2 ${isActive(
                "/about"
              )}`}
            >
              {t("navbar.menu1")}
            ...
            <Link
              to={getLinkWithLang("/mehmonxonalar")}
              className={`text-white md:ml-8 max-md:pt-8 max-md:pb-2 ${isActive(
                "/mehmonxonalar"
              )}`}
            >
